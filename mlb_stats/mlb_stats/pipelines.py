...
class Mlb_e_pitching_leaders:
    names = []
    def process_item(self, item, spider):
        file_e_pitching_l = open("e_pitching_leaders.csv", "a")
        for i in range(len(item[0])):
            index = 0
            if item[0][i] not in self.names:
                self.names.append(item[0][i])
                file_e_pitching_l.write(item[0][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[1][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[2][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[3][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[4][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[5][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[6][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[7][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[8][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[9][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[10][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[11][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[12][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[13][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[14][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[15][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[16][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[17][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[18][i])
                file_e_pitching_l.write("\n")
                file_e_pitching_l.write(item[19][i])
                file_e_pitching_l.write("\n")
        file_e_pitching_l.close()